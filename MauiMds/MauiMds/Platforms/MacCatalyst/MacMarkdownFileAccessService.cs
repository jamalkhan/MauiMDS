...
public sealed class MacMarkdownFileAccessService : IMarkdownFileAccessService
{
    private readonly ILogger<MacMarkdownFileAccessService> _logger;
    private readonly Dictionary<string, NSUrl> _securityScopedUrls = new(StringComparer.Ordinal);

    public MacMarkdownFileAccessService(ILogger<MacMarkdownFileAccessService> logger)
    {
        _logger = logger;
    }
