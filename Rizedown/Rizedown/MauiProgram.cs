...
#elif WINDOWS
using Rizedown.AudioCapture.Windows;
#endif
using Rizedown.Transcription;
using Rizedown.Features.Editor;
using Rizedown.Features.Export;
using Rizedown.Features.Session;
using Rizedown.Features.Workspace;
using Rizedown.Logging;
using Rizedown.Processors;
		...
		builder
			...
			.ConfigureMauiHandlers(handlers =>
			{
				handlers.AddHandler(typeof(Microsoft.Maui.Controls.Editor),
					typeof(Rizedown.Platforms.MacCatalyst.ShortcutAwareEditorHandler));
			})
#endif
			;
