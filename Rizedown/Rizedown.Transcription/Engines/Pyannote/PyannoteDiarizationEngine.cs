...
namespace Rizedown.Transcription.Engines.Pyannote;
...
public sealed class PyannoteDiarizationEngine : IDiarizationEngine
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var scriptPath = Path.Combine(Path.GetTempPath(), $"rizedown_pyannote_{Guid.NewGuid():N}.py");
        ...
        try
        {
            ...
            {
                tempWavPath = Path.Combine(Path.GetTempPath(), $"rizedown_pyannote_{Guid.NewGuid():N}.wav");
